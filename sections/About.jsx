...
const About = () => {
    ...
    useGSAP(() => {
        const ctx = gsap.context(() => {
            ...
            gsap.utils.toArray([".grid-1", ".grid-4"]).forEach((card) => {
                gsap.to(card, {
                    xPercent: 0,
                    opacity: 1,
                    duration: 0.8,
            ...
            gsap.utils.toArray([".grid-2", ".grid-3", ".grid-5"]).forEach((card) => {
                gsap.to(card, {
                    xPercent: 0,
                    opacity: 1,
                    duration: 0.8,
    ...
    return (
        <section ref={sectionRef} className="c-space mt-2 md:mt-10">
            ...
            <div ref={gridRef} className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
                ...
                {/* Grid 1 - From Left */}
                <div className="flex items-end grid-default-color grid-1" style={{ willChange: 'transform, opacity' }}>
                ...
                {/* Grid 2 - From Right */}
                <div className="grid-default-color grid-2" style={{ willChange: 'transform, opacity' }}>
                ...
                {/* Grid 3 - From Right */}
                <div className="grid-black-color grid-3" style={{ willChange: 'transform, opacity' }}>
                ...
                {/* Grid 4 - From Left (same as Grid 1) */}
                <div className="grid-special-color grid-4" style={{ willChange: 'transform, opacity' }}>
                ...
                {/* Grid 5 - From Right (same as Grid 2 & 3) */}
                <div className="grid-5" style={{ willChange: 'transform, opacity' }}>
